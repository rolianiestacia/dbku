            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="attendee-employee.php">Attendees</a>
                    </div>
                </div>
            </li>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h2 class="h4 mb-0 text-gray-800">Attendee  <i class="fas fa-check-square" style="color:#1d809f"></i></h2>
                         

                        <!-- <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class="fas fa-download fa-sm text-white-50"></i> Generate Report</a> -->
                    </div>
                    <div class="card shadow mb-4" style="min-height:430px" >
                        <div class="card-header py-3">
                            ...
                            if(isset($_POST['event']))
                            {
                                ...
                                echo '<span style="float: right">
                                       <a target="_blank" href="print-attendance-event-record.php?id='.$eid.'"><button class="btn btn-primary" style="background-color:#1d809f;border:1px solid #1d809f;width: 100px;"><i class="fa-solid fa-print"></i> Print</button></a>
                                    </span>';
                            }
                            else{
                        ...
                        <div class="card-body">
                        <form method="POST" id="myform" onchange="myfunction()">
                            <div class="row">
                                <div class="col-md-6">
                                    <select class="form-control" name="event" required>
                                        ...
                                        while($res=mysqli_fetch_assoc($query)){
                                            ...
                                            echo '<option value="'.$res['id'].'">'.$res['event_name'].'</option>';
                    ...
                    { 
                        $eid = $_POST['event'];
                        $query=mysqli_query($conn,"SELECT * FROM event WHERE id='$eid'");

                        $row=mysqli_fetch_assoc($query);
                        $rn=$row['room_num'];

                        $roomq = mysqli_query($conn,"SELECT * FROM room WHERE room_num='$rn'");
                    ...
                    ?>
                        <table id="thistable">
                        <tr>
                            <td>&nbsp;&nbsp;<b>Event ID</b>: <?php echo $row['id']; ?></td>
                            <td style="width:35%">&nbsp;&nbsp; <b>Event Name</b>: <?php echo $row['event_name']; ?></td>
                            <td style="width:35%">&nbsp;&nbsp;<b>Venue</b>: <?php echo $rn; ?></td>
                    ...
                    <hr><br> 
                            ...
                            <div style="overflow-x: auto">
                                <table class="table table-bordered centered" style="border: 0px;width:99%" align="center" id="datatablesSimple" cellspacing="0">
                                    <thead>
                                 ...
                                 <tbody>
                                     <?php
                                        $event_id = $row['id'];
                                        $sql = mysqli_query($conn,"SELECT * FROM event_attendees WHERE event_id='$event_id'");
                                        $count=1;
                                ...
                                <table class="table table-bordered centered" style="border: 0px;width:99%" align="center" id="datatablesSimple" cellspacing="0">
                                 ...
                                 <tbody>
                                     <?php
                                        ...
                                        $sql = mysqli_query($conn,"SELECT * FROM event_attendees");
                                        $count=1;
                                        if(mysqli_num_rows($sql)>0)
                                        {
                                            while($row=mysqli_fetch_assoc($sql))
