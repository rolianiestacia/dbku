...
$equery=mysqli_query($conn,"SELECT * FROM event_attendees");
$attendee=mysqli_num_rows($equery);

$empquery=mysqli_query($conn,"SELECT * FROM employee");
$emp=mysqli_num_rows($empquery);
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-2">
                             <div id="cardhover2">
                              <a href="#events" style="text-decoration: none"><div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <h3 class="card-title text-white">
                                            All Event</h3>
                                        <h1 class="text-white"><strong><?php echo $event;?></strong></h1>
                                    </div>
                                    <div class="col-auto">
                                        <i style="font-size: 3rem;opacity: 0.5;color: white" class="fa fa-calendar"></i>
                                    </div>
                                </div>
                            </div></a>
                         </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-3">
                            <div id="cardhover3">
                              <a href="attendee.php" style="text-decoration: none"><div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <h3 class="card-title text-white">
                                            Attendees</h3>
                                        <h1 class="text-white"><strong><?php echo $attendee;?></strong></h1>
                                    </div>
                                    <div class="col-auto">
                                        <i style="font-size: 3rem;opacity: 0.5;color: white" class="fas fa-list"></i>
                                    </div>
                                </div>
                            </div></a>
                         </div>
                     ...
                     <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-4">
                            <div id="cardhover4">
                              <a href="#employee" style="text-decoration: none"><div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <h3 class="card-title text-white">Employee</h3>
                                        <h1 class="text-white"><strong><?php echo $emp; ?></strong></h1>
                                    </div>
                                    <div class="col-auto">
                                        <i style="font-size: 3rem;opacity: 0.5;color: white" class="fas fa-users"></i>
                                    </div>
                                </div>
                            </div></a>
                         </div>
                        ...
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            ...
                            <div class="dropdown no-arrow">
                                ...
                                <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                                    ...
                                    <a class="dropdown-item" href="calendar.php">Go to Calendar</a>
                                    <a class="dropdown-item" href="event-mgt.php">Manage Events</a>
                                </div>
                            </div>
                        </div>
                        <!-- Card Body -->
                        <div class="card-body">
                             <iframe onload="resizeIframe(this)" style="border: 0px;width: 100%;height: 640px;" src="dashboard-calendar-admin.php"></iframe>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card shadow mb-4" id="today">
                        ...
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            ...
                            <div class="dropdown no-arrow">
                                ...
                                <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                                    aria-labelledby="dropdownMenuLink">
                                    <a class="dropdown-item" href="event-mgt.php" target="_parent">Manage Event</a>
                                </div>
                            </div>
                        </div>
                         <!-- Card Body -->
            ...
            <div class="row">
                ...
                <div class="col-xl-12">
                    <div class="card shadow mb-4" id="events">
                        <!-- Card Header - Dropdown -->
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    ...
                    <div class="card shadow mb-4" id="employee">
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            ...
                            <div class="dropdown no-arrow">
                                ...
                                <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                                    aria-labelledby="dropdownMenuLink">
                                    <a class="dropdown-item" href="employee-mgt.php" target="_parent">Manage Employee</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                           <iframe src="dashboard-employee-mgt.php" style="width: 100%;border: 0px;min-height:500px"></iframe>
                        </div>
                    </div>
