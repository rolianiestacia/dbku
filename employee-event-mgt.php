...
<head>
    ...
    <title>DAMS - Employee Event</title>
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="attendance-record.php">Attendance Records</a>
                         <a class="collapse-item active" href="employee-event-mgt.php">Employee Events</a>
                    </div>
                </div>
            </li>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h2 class="h4 mb-0 text-gray-800">Employee Events  <i class="fas fa-id-badge"></i></h2>
                                ...
                                <div class="col-md-6">
                                    <select class="form-control" name="employee" required>
                                        ...
                                        while($res=mysqli_fetch_assoc($query)){
                                            ...
                                            echo '<option value="'.$res['emp_id'].'">'.$res['emp_id'].' - '.$res['emp_name'].'</option>';
                    ...
                    { 
                        $eid = $_POST['employee'];
                        $query=mysqli_query($conn,"SELECT * FROM employee WHERE emp_id='$eid'");
                    ...
                    ?>
                        <table id="thistable">
                        <tr>
                            <td style="width:35%">&nbsp;&nbsp; <b>Employee ID</b>: <?php echo $row['emp_id']; ?></td>
                            <td colspan="2">&nbsp;&nbsp;<b>Name</b>: <?php echo $row['emp_name']; ?></td>
                        </tr>
                        <tr>
                            <td style="width:35%">&nbsp;&nbsp;<b>MyKad</b>: <?php echo $row['emp_mykad']; ?></td>
                            <td>&nbsp;&nbsp;<b>Email</b>: <?php echo $row['emp_email']; ?></td>
                            <td>&nbsp;&nbsp;<b>Department</b>: <?php echo $row['emp_department']; ?></td>
                        </tr> 
                    </table><br>
                    <hr><br> 
                            ...
                            <div style="overflow-x: auto">
                                <table class="table table-bordered centered" style="border: 0px;width:99%" align="center" id="datatablesSimple" cellspacing="0">
                                 ...
                                 <tbody>
                                     <?php
                                        $emp_id = $row['emp_id'];
                                        $sql = mysqli_query($conn,"SELECT * FROM employee_event WHERE emp_id='$emp_id'");
                                        $count=1;
                                        if(mysqli_num_rows($sql)>0)
                                        {
                                            ...
                                            {   
                                                ...
                                                $rn =$res['room_num'];
                                                $roomquery = mysqli_query($conn,"SELECT * FROM room WHERE room_num='$rn'");
                                                $roomrow = mysqli_fetch_assoc($roomquery);
                                                $venue = $roomrow['room_name'];
                                                ...
                                                echo '<tr>
                                                        ...
                                                        <td>'.$ename.'</td>
                                                        <td>'.$venue.'</td>
                                                        <td> <b>Start</b> : '.$res['start_datetime'].'<br><b>End</b> : '.$res['end_datetime'].'</td>
                                                        <td>'.$row['check_in'].'</td>
                                                        <td>'.$row['location'].'</td>
