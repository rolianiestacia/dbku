...
$id=$_GET['id'];
$query=mysqli_query($conn,"SELECT * FROM event WHERE id='$id' LIMIT 1");
$row=mysqli_fetch_assoc($query);

$room = $row['room_num'];
$roomquery = mysqli_query($conn,"SELECT * FROM room WHERE room_num='$room' LIMIT 1");
$roomn = mysqli_fetch_assoc($roomquery);
$room_name = $roomn['room_name'];

$rquery=mysqli_query($conn,"SELECT * FROM employee_event WHERE event_id='$id'");
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h4 class="h4 mb-0 text-gray-800">Event and Employee Management <i class="fas fa-users"></i></h4>
                             ...
                             <div class="row page-titles mx-0">
                                <div class="col p-md-0">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active"><a style="text-decoration: none;font-size:14px" href="javascript:void(0)">Assign Employee to Event</a></li>
                                    </ol>
                                </div>
                            </div> 
                        </span>  
                                    ...
                                    <tr>
                                        ...
                                        <td> 
                                            <span style="float: right">
                                               <button data-id="<?php echo $row['id']; ?>" class="addsubject btn btn-primary" style="background-color:#1d809f;border:1px solid #1d809f;font-size: 13px;"><i class="fa-solid fa-circle-plus"></i> Add Employee to Event</button>
                                            </span>
                                        </td>
                                    </tr>
                                </table>
                    ...
                    <div id="view_classes">
                            <div class="card-body">
                                ...
                                <table id="thistable">
                                    <tr>
                                        <td style="width:35%">&nbsp;&nbsp; <b>Event Name</b>: <?php echo $row['event_name']; ?></td>
                                        <td style="width:35%">&nbsp;&nbsp;<b>Venue</b>: <?php echo $room_name; ?></td>
                                        <td>&nbsp;&nbsp;<b>Quota</b>: <?php echo $row['event_attendees_quota']; ?></td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;&nbsp;<b>Time</b>: <?php echo $row['start_datetime']; ?> - <br>&nbsp;&nbsp;<?php echo $row['end_datetime'];?></td>
                                        <td>&nbsp;&nbsp;<b>Registration Close</b>: <?php echo $row['endreg_datetime']; ?></td>
                                        <td>&nbsp;&nbsp;<b>Status</b>: <?php echo $row['status']; ?></td>
                                    </tr> 
                                    <tr>
                                        <td colspan="3">&nbsp;&nbsp;<b>Description</b>: <?php echo $row['description']; ?></td>
                                    </tr>
                                </table><br>
                                <hr><br>
                                <div style="overflow-x: auto">
                                     <table class="table table-bordered mid-txt" style="border: 0px solid #d9d9d9 !important;" id="datatablesSimple" width="100%" cellspacing="0">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            <?php
                                            $count=1;
                                            while($res=mysqli_fetch_assoc($rquery))
                                            {
                                                $eid = $res['emp_id'];
                                                $name=mysqli_query($conn,"SELECT * FROM employee WHERE emp_id='$eid' LIMIT 1");
                                                $gname = mysqli_fetch_assoc($name);
                                                $ename = $gname['emp_name'];
                                                $remarks = "";
                                                if($res['location'] != "")
                                                {
                                                    $remarks = 'Check in: '.$res['check_in'].'\n Location: '.$res['location'];
                                                }
                                                ?>
                                                <tr>
                                                    <td><center><?php echo $count;?></center></td>
                                                    <td><center><?php echo $eid;?></center></td>
                                                    <td><center><?php echo $ename;?></center></td>
                                                    <td><center><?php echo $remarks;?></center></td>
                                                    <td style="width:11%"><center><a href="delete-employee-event.php?emp_id=<?php echo $res['emp_id']; ?>&event_id=<?php echo $res['event_id']; ?>"><button onclick="return confirm('Are you sure you want to delete <?php echo $ename; ?> from <?php echo $row['event_name']; ?>')" class="btn btn-link"><i class="fa-solid fa-trash-can"></i></button></a></center></td>
                                                </tr>
