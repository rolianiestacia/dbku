...
<head>
    ...
    <title>DAMS - Employee Management</title>
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item active" href="employee-mgt.php">Employee Details</a>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Employee  <i class="fas fa-users"></i></h1>
                                    ...
                                    <tr>
                                        ...
                                        <td> 
                                            <span style="float: right">
                                               <button data-id="<?php echo $admin; ?>" class="addsubject btn btn-primary" style="background-color:#1d809f;border:1px solid #1d809f;"><i class="fa-solid fa-circle-plus fa-lg"></i> New Employee</button>
                                            </span>
                                        </td>
                                    </tr>
                                </table>
                                        ...
                                        if(mysqli_num_rows($query)>0)
                                        {
                                            ...
                                            {   
                                                ...
                                                echo '<tr>
                                                        ...
                                                        <div class="row">
                                                            <div class="col"> <button data-id="<?php echo $row['emp_id']; ?>" class='editsubject btn btn-link'><i class="fa-solid fa-pen-to-square"></i></button></div>
                                                            <div class="col"><a href="delete-employee.php?delete=<?php echo $row['emp_id']; ?>"><button onclick="return confirm('Are you sure you want to delete <?php echo $row['emp_name']; ?>')" class="btn btn-link"><i class="fa-solid fa-trash-can"></i></button></a></div>
                                                        </div>
                                                        </td>
                                                     </tr>
                                        <?php
...
function myfunction() {
  ...
  x = document.getElementById("emp_mykad").value;
