                                    ...
                                    <tr>
                                        ...
                                        <td> 
                                            <span style="float: right">
                                               <button data-id="<?php echo $admin; ?>" class="addsubject btn btn-primary" style="background-color:#1d809f;border:1px solid #1d809f;font-size: 12px;"><i class="fa-solid fa-plus"></i> New Event</button>
                                            </span>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <div style="overflow-x: auto">
                                <table class="table table-bordered" style="border: 0px;width:99%" align="center" id="datatablesSimple" cellspacing="0">
                                    <thead>
                                        ...
                                        <th><center>Assign Staff</center></th>
                                        <th><center>Attendance QR Code</center></th>
                                        ...
                                        if(mysqli_num_rows($query)>0)
                                        {
                                            ...
                                            {   
                                                ...
                                                echo '<tr>
                                                  ...
                                                  echo '<td align="center" style="vertical-align: middle;"><a href="employee-event.php?id='.$row['id'].'"><i class="fa-solid fa-user-plus fa-lg"></i></a></td>';

                                                  echo '<td align="center" style="vertical-align: middle;"><a href="attendance-qrcode.php?id='.$row['qrcode_id'].'"><i class="fa-solid fa-qrcode fa-xl"></i></a></td>';
                                        
                                                  echo '<td align="center" style="vertical-align: middle;width:14%">'; ?>
                                                        <div class="row">
                                                            <div class="col"> <button data-id="<?php echo $row['id']; ?>" class='editsubject btn btn-link'><i class="fa-solid fa-pen-to-square"></i></button></div>
                                                            <div class="col"><a href="delete-event.php?delete=<?php echo $row['id']; ?>"><button onclick="return confirm('Are you sure you want to delete <?php echo $row['event_name']; ?>')" class="btn btn-link"><i class="fa-solid fa-trash-can"></i></button></a></div>
                                                        </div>
                                                        </td>
                                                     </tr>
                                        <?php
