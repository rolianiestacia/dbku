            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-6">
                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                        ...
                        <div class="card-body">
                            <form action="forgotpw-employee.php" method="POST">
                            ...
                            ?>
                              <br>                                          
                               ...
                               <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input class="form-control button" style="background-color: #50B8B3 !important;color: white" type="submit" name="check-email" value="Continue">
                                </div>


                                <center><a style="color:blue;text-decoration: none" href="signin-employee.php">Return to sign in</a></center>
