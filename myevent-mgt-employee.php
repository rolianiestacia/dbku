                        ...
                        <span class="d-none d-sm-inline-block">
                             <div class="row page-titles mx-0">
                                <div class="col p-md-0">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a style="text-decoration: none"href="event-mgt-employee.php" target="_parent">Events</a></li>
                                        <li class="breadcrumb-item active"><a style="text-decoration: none" href="javascript:void(0)">My Events</a></li>
                                    </ol>
                                </div>
                            </div> 
                        </span>  
                    ...
                    <div class="card shadow mb-4" >
                        <div class="card-header py-3">
                            <table style="width: 100%" >
                                    <tr>
                                        <td><span style="display: block;height: 30px;"> Employee ID: <?php echo $_SESSION['user'];?></span></td>
                                        <td> 
                                ...
                                <table class="table table-bordered" style="border: 0px;width:99%" align="center" id="datatablesSimple" cellspacing="0">
                                 ...
                                 <tbody>
                                     <?php
                                        ...
                                        $query=mysqli_query($conn,"SELECT * FROM employee_event WHERE emp_id='$user'");
                                         ...
                                         if(mysqli_num_rows($query)>0)
                                        {
                                            ...
                                            {  
                                                 ...
                                                 $query2=mysqli_query($conn,"SELECT * FROM event WHERE id='$event_id'");
                                                 $res = mysqli_fetch_assoc($query2);
                                                 $roomnum = $res['room_num'];

                                                  $query3=mysqli_query($conn,"SELECT * FROM room WHERE room_num='$roomnum'");
                                                 $res2 = mysqli_fetch_assoc($query3);
                                                 $roomname = $res2['room_name'];

                                                 echo '<tr>
                                                        <td align="center" style="vertical-align: middle;">'.$count.'</td>
                                                        <td align="center" style="vertical-align: middle;">'.$row['event_id'].'</td>
                                                        <td align="center" style="vertical-align: middle;">'.$res['event_name'].'</td>
                                                        <td align="center" style="vertical-align: middle;">'.$roomname.'</td>
                                                        <td align="center" style="vertical-align: middle;">'.$res['event_attendees_quota'].'</td>
                                                        <td style="vertical-align: middle;"><b>Start</b>: '.$res['start_datetime'].'<br><br>
                                                        <b>End</b>: '.$res['end_datetime'].'</td>
                                                        <td align="center" style="vertical-align: middle;">'.$res['description'].'</td>
                                                        <td align="center" style="vertical-align: middle;">'.$res['endreg_datetime'].'</td>
                                                        
                                                  <td align="center" style="vertical-align: middle;">'.$res['status'].'</td>
