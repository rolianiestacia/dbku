                        ...
                        <div class="card-body">
                            <form action="new-password.php" method="POST" autocomplete="off">
                              ...
                              <br>                                          
                                ...
                                <div class="form-group">
                                    <input class="form-control button" type="submit" name="change-password" style="background-color: #50B8B3;color: white" value="Change">
                                </div>
                                 <center><a style="text-decoration: none;color:blue" href="signin-employee.php">Return to sign in</a></center>
                            </form>
                        </div>
                    </div>
                </div>
