...
<html lang="en">
    <head>
        ...
        <title>DAMS - Print Registration</title>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                        <div class="card-header"><h3 class="text-center font-weight-light my-4">Register Event</h3></div>
                        <div class="card-body">
                            <form action="print.php" target="_blank" method="POST">
                              ...
                              <div class="form-group">
                                ...
                                <input class="form-control button" style="background-color: #50B8B3;color: white;width:90%" type="submit" name="submit" value="Print"></center>
                              </div>   
                              <center><a style="text-decoration: none;color:blue" href="index.php">Back</a></center>                                     
