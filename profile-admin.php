...
if(isset($_POST['submit']))
{
  ...
  {
     $res=mysqli_query($conn,"UPDATE admin SET email='$email' WHERE username='$admin'");
     $_SESSION['savedmessage']='Saved!';
                   ...
                   <div class="limiter">
                    <div class="row justify-content-center" style="font-family: 'Lucida Console', 'Courier New', monospace;">
                      ...
                      <?php endif ?>
                            ...
                            <form action="profile-admin.php" class="login100-form validate-form" method="POST">
                              <div class="wrap-input100 validate-input m-b-26">
                                <span class="label-input100">Username</span>
                                <input class="input100" type="text" name="username" value="<?php echo $_SESSION['admin'];?>" readonly >
                                <span class="focus-input100"></span>
                              </div><br>
                              <div class="wrap-input100 validate-input m-b-26">
                                <span class="label-input100">E-mail</span>
                                <input class="input100" type="email" name="email" value="<?php echo $row['email'];?>" required>
                                <span class="focus-input100"></span>
                              </div>
