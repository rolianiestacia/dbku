            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                        ...
                        <div class="card-body">
                            <form action="reset-code-admin.php" method="POST" autocomplete="off">
                               <?php 
                              ...
                              <br>                                          
                                ...
                                <div class="form-group">
                                    <input class="form-control button" type="submit" style="background-color: #50B8B3;color: white" name="check-reset-otp-admin" value="Submit">
                                </div>
                                 <center><a style="text-decoration: none;color:blue" href="forgotpw-admin.php">Back</a></center>
