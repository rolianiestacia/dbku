            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h2 class="h3 mb-0 text-gray-800">Room  <i class="fas fa-university"></i></h2>
                                    ...
                                    <tr>
                                        ...
                                        <td> 
                                            <span style="float: right">
                                               <button data-id="<?php echo $admin; ?>" class="addsubject btn btn-primary" style="background-color:#1d809f;border:1px solid #1d809f;"><i class="fa-solid fa-circle-plus"></i> New Room</button>
                                            </span>
                                        </td>
                                    </tr>
                                </table>
                                        ...
                                        if(mysqli_num_rows($query)>0)
                                        {
                                            ...
                                            {   
                                                ...
                                                echo '<tr>
                                                        ...
                                                        <div class="row">
                                                            <div class="col"> <button data-id="<?php echo $row['room_num']; ?>" class='editsubject btn btn-link'><i class="fa-solid fa-pen-to-square"></i></button></div>
                                                            <div class="col"><a href="delete-room.php?delete=<?php echo $row['room_num']; ?>"><button onclick="return confirm('Are you sure you want to delete <?php echo $row['room_name']; ?>')" class="btn btn-link"><i class="fa-solid fa-trash-can"></i></button></a></div>
                                                        </div>
                                                        </td>
                                                     </tr>
                                        <?php
