            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h2 class="h3 mb-0 text-gray-800">Attendance Records  <i class="fas fa-users"></i></h2>
                          <span class="d-none d-sm-inline-block">
                             <div class="row page-titles mx-0">
                                <div class="col p-md-0">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a style="text-decoration: none"href="attendance-record.php" target="_parent">Employees</a></li>
                                        <li class="breadcrumb-item active"><a style="text-decoration: none" href="javascript:void(0)">Attendance Record</a></li>
                                    </ol>
                                </div>
                            </div> 
                        </span>  
                    ...
                    <div class="card shadow mb-4" >
                         <div class="card-header py-3">
                            <table style="width: 100%">
                                    <tr>
                                        <td><i class="fas fa-user"></i>&nbsp;&nbsp;&nbsp;<b>Employee ID: <?php echo $row['emp_id'];?></b></td>
                                        
                                        <td> 
                                            <span style="float: right">
                                               <a target="_blank" href="print-attendance-record.php?id=<?php echo $row['emp_id'];?>"><button class="btn btn-primary" style="background-color:#1d809f;border:1px solid #1d809f;width: 100px;"><i class="fa-solid fa-print"></i> Print</button></a>
                                            </span>
                                        </td>
                                    </tr>
                                </table>
